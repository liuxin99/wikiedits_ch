#!/home/lx2021/miniconda3/envs/wikiedits_py3_env/bin/python
# -*- coding: UTF-8 -*-
...
def main():
    ...
    old_text_file = open(args.old_text_file,'r', encoding='utf-8')
    new_text_file = open(args.new_text_file,'r', encoding='utf-8')
...
def parse_user_args():
    ...
    group.add_argument("-l", "--language", default="chinese",
                       help="specify language of NLTK sentence splitter, if Chinese, then use chinese sentence split method",
                       choices=LANGUAGES)
